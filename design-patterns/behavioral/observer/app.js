...
function reportCurrentSpeed(newValue, oldValue) {
    console.log("Car running at " + newValue + " km/h");
}
function checkSpeedLimit(newValue, oldValue) {
    var speedLimit = 100;
